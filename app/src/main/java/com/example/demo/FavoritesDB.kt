...
class FavoritesDB(context: Context) : SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {
    ...
    fun getAllNames(): List<String> {
        ...
        if (cursor != null) {            val nameIndex = cursor.getColumnIndex(COLUMN_NAME)
